...
I am primarily a server side dev deal with a lot for DevOps tools almost everyday and specially a CI server. Some of the pain points I see in systems like Jenkins and GoCD are:
...
- Use GPL and be FOSS
- Have a very small core with a limited features set. And be opinionated ONLY about them. (Inspired by GoCD)
...
- Build pretty much everything else via plugins:
  ...
  - Things like getting stuff from from a VCS can be a plugin which can abstract away the type like Github or Bitbucket and do stuff like auth and finally give bob the direct resource URL.
...
And this is a project born out my frustration and is VERY new. 😄 
