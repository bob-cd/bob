...
(defn check-entities
  [{db :db}]
  (let [artifact-stores (store/kv-list db store/artifact-store-bucket)
        resource-providers (store/kv-list db store/resource-provider-bucket)
        loggers (store/kv-list db store/logger-bucket)]
